...
class RangeList {
 public:
  RangeList(const CompileUnit* _compileUnit, Span<const std::byte> _data,
            FileAddr _baseAddr)
...
class RangeList::iterator {
 public:
  ...
  iterator(const CompileUnit* _compileUnit, Span<const std::byte> _data,
...
class Attr {
 public:
  Attr(const CompileUnit* _compileUnit, std::uint64_t _type,
       std::uint64_t _form, const std::byte* _location)
...
class LineTable {
 public:
  ...
  LineTable(Span<const std::byte> _data, const CompileUnit* _compileUnit,
            bool _defaultIsStmt, std::int8_t _lineBase, std::uint8_t _lineRange,
  ...
  std::vector<iterator> GetEntriesByLine(std::filesystem::path path,
...
class CompileUnit {
 public:
  CompileUnit(Dwarf& _parent, Span<const std::byte> _data,
...
class Die {
 public:
  ...
  Die(const std::byte* _position, const CompileUnit* _compileUnit,
      const Abbrev* _abbrev, std::vector<const std::byte*> _attrLocations,
